...
python3 -m pytest -v --tb=short -s --reruns 2 --reruns-delay 2 -k test_landing_links_present --ini-config "$INI_CONFIG_FILE" --html=$HOST_ARTIFACTS/test_report_$(date +%Y-%m-%d_%H-%M-%S).html
