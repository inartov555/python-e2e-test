...
def setup_elements_for_test(request):
    ...
    request.cls.landing_page = LandingPage(request.cls.app_config.base_url, request.cls.page, request)
    request.cls.signup_page = SignupPage(request.cls.app_config.base_url, request.cls.page, request)
    request.cls.login_page = LoginPage(request.cls.app_config.base_url, request.cls.page, request)
    request.cls.home_page = HomeFeedPage(request.cls.app_config.base_url, request.cls.page, request)
